#!/usr/bin/env bash
# Apply Wave A Dashflow stack to the current kubectl context (AKS).
#
# Usage:
...
#   - images already pushed (build-push-acr.sh)
...
echo "Pipelet image pattern: $IMAGE_PATTERN"
